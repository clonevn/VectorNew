...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('max_session')); ?>:</b>
	<?php echo CHtml::encode($data->max_session); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('total_session')); ?>:</b>
	<?php echo CHtml::encode($data->total_session); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('remain_session')); ?>:</b>
	<?php echo CHtml::encode($data->remain_session); ?>
	<br />
