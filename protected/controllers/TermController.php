	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Term']))
		{
			$model->attributes=$_POST['Term'];
                      //  $date_start = new DateTime($model->date_start);
                       // $week_number = $model->week_number;
                       // $str = "+".$week_number." weeks";
                       // $date_start->modify("+{$week_number} weeks");
                       // $date1 = $date_start->format('Y-m-d');
                        //$date_end = $week_number;

                       // $model->date_end = $date_start;
                        $model->date_start = date_create((String)$model->date_start)->format('Y-m-d');
                        $model->status = Term::STATUS_ONGOING;  
